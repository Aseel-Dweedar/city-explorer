    ...
    return (
      <Card
         ...
         style={{ width: "30%", height: "100%" , margin: 'Auto', marginBottom: '30px'}}>
            <Image style={{ width: "100%" }} src={`https://maps.locationiq.com/v3/staticmap?key=pk.d36871f015649f915282f374cff76628&q&center=${this.props.cityInfo.lat},${this.props.cityInfo.lon}&zoom=15`} rounded  />
         <Card.Body>
